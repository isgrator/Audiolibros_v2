...
public class ZoomSeekBar extends View {
    ...
    //MÉTODOS
    //Se llama una vez conocido el ancho y alto de la vista
    @Override
    ...
    //Métodos para dotar que reaccionea eventos***************************************
    ...
    public void setEscalaRaya(int escalaRaya) {
        if(escalaRaya <= this.escalaMax-2 && escalaRaya > 0) {
